...
export const metadata = { title: '카르마 학원' };

const ACADEMY_SECTIONS = [
  { slug: 'admission', label: '입학 안내', icon: '🚪', desc: '수업 시간, 반 편성, 수강료 등 입학 관련 안내입니다.' },
  { slug: 'graduates', label: '졸업생 후기', icon: '🎓', desc: '카르마 학원을 거쳐 간 학생들의 생생한 후기입니다.' },
...
export default function AcademyPage() {
  return (
    <PageShell>
      <div className="mb-10">
        <p className="text-purple-600 font-medium text-sm mb-1">카르마 학원</p>
        <h1 className="text-4xl font-bold mb-3">카르마 영어학원</h1>
        <p className="text-gray-500">입학 안내부터 졸업생 후기까지, 카르마 학원의 모든 정보를 확인하세요.</p>
      </div>
